...
const features = [
  {
    title: "AI Destekli Sanat",
    description: "Stable Diffusion ve DALL-E ile resim üretimi, Llama2 ile sohbet, MusicGen ile müzik, Text-to-Video ile video oluşturma.",
    icon: Sparkles,
